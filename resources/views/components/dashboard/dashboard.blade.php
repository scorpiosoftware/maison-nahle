...
<aside
    ...
    <div
        class="h-full px-3 pb-4 overflow-y-auto bg-gradient-to-b from-pink-500 via-purple-600 to-white d:bg-gray-800 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-400 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb:hover]:bg-gray-500">
        <ul class="space-y-2 font-medium text-black">
            <li class="bg-white rounded-lg">
                <a href="{{ route('dashboard.index') }}" wire:navigate
                    ...
                    <svg class="w-5 h-5  transition duration-75 d:text-gray-400 " aria-hidden="true"
            ...
            <li class="bg-white rounded-lg">
                <a href="{{ route('carousel.index') }}" wire:navigate
            ...
            <li class="bg-white rounded-lg">
                <a href="{{ route('inbox.index') }}" wire:navigate
                    class="flex items-center p-2 rounded-lg hover:bg-gray-100 group">
                    <svg class="w-6 h-6  d:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
