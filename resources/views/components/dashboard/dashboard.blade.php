...
<nav
    class="fixed top-0  z-50 w-full bg-white/95 backdrop-blur-md border-b border-gray-200/50 shadow-sm transition-all duration-300">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar"
                    ...
                    <svg class="w-6 h-6 transition-transform duration-200 group-hover:scale-110" fill="currentColor"
                        viewBox="0 0 20 20">
                ...
                {{-- Logo Section --}}
                <a href="/"
                    class="flex items-center {{ session('lang') == 'ar' ? 'mr-4 md:ml-24' : 'ml-4 md:mr-24' }} group">
                    <div class="relative">
                        <img src="{{ URL::to('storage/' . $logo) }}"
                            class="h-10  p-2 rounded-md transition-all duration-300 group-hover:scale-105"
                            alt="Logo" />
                        <div
            ...
            <div class="flex items-center space-x-4 rtl:space-x-reverse">
                ...
                <livewire:language>
                    ...
                    <button
                        class="relative p-2.5 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all duration-200 group">
                        <svg class="w-6 h-6 group-hover:scale-110 transition-transform duration-200" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M15 17h5l-5-5-5 5h5zm0 0v-14a6 6 0 10-12 0v14"></path>
                        </svg>
                    ...
                    <div class="flex items-center">
                        <div class="relative">
                            <button type="button"
                                ...
                                <span
                                    class="sr-only">{{ session('lang') == 'en' ? 'Open user menu' : 'فتح قائمة المستخدم' }}</span>
                                ...
                                <ul class="py-2">
                                    <li>
                                        <a href="{{ route('dashboard.index') }}"
                                            ...
                                            <svg class="w-5 h-5 {{ session('lang') == 'ar' ? 'ml-3' : 'mr-3' }} text-gray-400 group-hover:text-blue-500 transition-colors duration-200"
                                    ...
                                    <li>
                                        <a href="{{ route('profile.edit', Auth::user()->id) }}"
                                            class="flex items-center px-6 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-200 group">
                                            <svg class="w-5 h-5 {{ session('lang') == 'ar' ? 'ml-3' : 'mr-3' }} text-gray-400 group-hover:text-purple-500 transition-colors duration-200"
                                                fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <li class="border-t border-gray-100/50 mt-2 pt-2">
                                        <form action="{{ route('logout') }}" method="POST">
                                            ...
                                            <button
                                                ...
                                                <svg class="w-5 h-5 {{ session('lang') == 'ar' ? 'ml-3' : 'mr-3' }} group-hover:text-red-700 transition-colors duration-200"
...
<aside id="logo-sidebar"
    ...
    {{-- Sidebar Content --}}
    <div
        class="h-full px-4 pb-4 overflow-y-auto bg-white scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent hover:scrollbar-thumb-gray-400">
        <nav class="space-y-2 font-medium mt-4">
            ...
            <a href="{{ route('dashboard.index') }}"
                ...
                <div
                    class="flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-blue-100 to-purple-100 group-hover:from-blue-200 group-hover:to-purple-200 transition-all duration-300">
                ...
                <span
                    class="{{ session('lang') == 'ar' ? 'mr-3' : 'ml-3' }} font-medium">{{ session('lang') == 'en' ? 'Dashboard' : 'لوحة التحكم' }}</span>
                <svg class="w-4 h-4 {{ session('lang') == 'ar' ? 'mr-auto rotate-180' : 'ml-auto' }} opacity-0 group-hover:opacity-100 transition-all duration-300"
                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('social.index') }}"
                ...
                <div
                    class="flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-purple-100 to-pink-100 group-hover:from-purple-200 group-hover:to-pink-200 transition-all duration-300">
                    <svg class="w-5 h-5 text-purple-600 group-hover:text-purple-700 transition-colors duration-300"
                        fill="currentColor" viewBox="0 0 24 24">
                        <path
                            d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c1.54 0 3-.35 4.31-.99-.7-.57-1.31-1.25-1.78-2.04-1.17.59-2.49.94-3.88.94C7.93 19.91 4.09 16.07 4.09 11.36S7.93 2.8 12.65 2.8s8.56 3.84 8.56 8.56c0 1.39-.35 2.71-.94 3.88.79.47 1.47 1.08 2.04 1.78C22.65 15.01 23 13.54 23 12c0-5.52-4.48-10-10-10z" />
                    </svg>
                </div>
                <span
                    class="{{ session('lang') == 'ar' ? 'mr-3' : 'ml-3' }} font-medium">{{ session('lang') == 'en' ? 'Social Accounts' : 'التواصل الاجتماعي' }}</span>
            </a>
            ...
            <a href="{{ route('inbox.index') }}"
                ...
                <div
                    class="flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-yellow-100 to-orange-100 group-hover:from-yellow-200 group-hover:to-orange-200 transition-all duration-300">
                    <svg class="w-5 h-5 text-yellow-600 group-hover:text-yellow-700 transition-colors duration-300"
                        fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
                ...
                <span
                    class="{{ session('lang') == 'ar' ? 'mr-3' : 'ml-3' }} font-medium">{{ session('lang') == 'en' ? 'Inbox' : 'البريد الوارد' }}</span>
                {{-- Notification badge --}}
                <span
                    class="inline-flex items-center justify-center w-5 h-5 {{ session('lang') == 'ar' ? 'mr-auto' : 'ml-auto' }} text-xs font-bold text-white bg-red-500 rounded-full animate-pulse">3</span>
            </a>
            <a href="{{ route('reviews.index') }}"
                ...
                <span
                    class="{{ session('lang') == 'ar' ? 'mr-3' : 'ml-3' }} font-medium">{{ session('lang') == 'en' ? 'Reviews' : 'التقييمات' }}</span>
                {{-- Notification badge --}}
            </a>
            {{-- Product Views --}}
            <a href="{{ route('productView.index') }}"
                ...
                <div
                    class="flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-indigo-100 to-blue-100 group-hover:from-indigo-200 group-hover:to-blue-200 transition-all duration-300">
                    <svg class="w-5 h-5 text-indigo-600 group-hover:text-indigo-700 transition-colors duration-300"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <span
                    class="{{ session('lang') == 'ar' ? 'mr-3' : 'ml-3' }} font-medium">{{ session('lang') == 'en' ? 'Product Views' : 'عرض المنتجات' }}</span>
            </a>
            ...
            <a href="{{ route('ads.index') }}"
                ...
                <div
                    class="flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-rose-100 to-pink-100 group-hover:from-rose-200 group-hover:to-pink-200 transition-all duration-300">
                    <svg class="w-5 h-5 text-rose-600 group-hover:text-rose-700 transition-colors duration-300"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <span
                    class="{{ session('lang') == 'ar' ? 'mr-3' : 'ml-3' }} font-medium">{{ session('lang') == 'en' ? 'Ads Manager' : 'إدارة الإعلانات' }}</span>
            </a>
            ...
            <div x-data="{ open: false }" class="relative">
                <button type="button" @click="open = !open"
                    ...
                    <div
                        class="flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-slate-100 to-gray-100 group-hover:from-slate-200 group-hover:to-gray-200 transition-all duration-300">
                        <svg class="w-5 h-5 text-slate-600 group-hover:text-slate-700 transition-colors duration-300"
                    ...
                    <span
                        class="flex-1 {{ session('lang') == 'ar' ? 'mr-3 text-right' : 'ml-3 text-left' }} font-medium">
                    ...
                    <ul x-show="open" x-transition:enter="transition ease-out duration-300"
                        ...
                        <li>
                            <a href="{{ route('storeSections.index') }}"
                                ...
                                <svg class="w-4 h-4 {{ session('lang') == 'ar' ? 'ml-2' : 'mr-2' }} text-gray-400 group-hover:text-blue-500 transition-colors duration-200"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <li>
                            <a href="{{ route('branch.index') }}"
                                ...
                                <svg class="w-4 h-4 {{ session('lang') == 'ar' ? 'ml-2' : 'mr-2' }} text-gray-400 group-hover:text-green-500 transition-colors duration-200"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <li>
                            <a href="{{ route('category.index') }}"
                                ...
                                <svg class="w-4 h-4 {{ session('lang') == 'ar' ? 'ml-2' : 'mr-2' }} text-gray-400 group-hover:text-purple-500 transition-colors duration-200"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <li>
                            <a href="{{ route('brand.index') }}"
                                ...
                                <svg class="w-4 h-4 {{ session('lang') == 'ar' ? 'ml-2' : 'mr-2' }} text-gray-400 group-hover:text-indigo-500 transition-colors duration-200"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <li>
                            <a href="{{ route('color.index') }}"
                                ...
                                <svg class="w-4 h-4 {{ session('lang') == 'ar' ? 'ml-2' : 'mr-2' }} text-gray-400 group-hover:text-yellow-500 transition-colors duration-200"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v1.586l8.707 8.707a1 1 0 010 1.414L13.414 22.414a1 1 0 01-1.414 0L4.293 14.707A1 1 0 014 14.293V10a2 2 0 012-2h2m3-3v18m0-18a2 2 0 012 2v1M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4">
                                    </path>
                                </svg>
                        ...
                        <li>
                            <a href="{{ route('size.index') }}"
                                ...
                                <svg class="w-4 h-4 {{ session('lang') == 'ar' ? 'ml-2' : 'mr-2' }} text-gray-400 group-hover:text-orange-500 transition-colors duration-200"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M4 8V4a1 1 0 011-1h4m0 0V1a1 1 0 011-1h4a1 1 0 011 1v2m0 0h4a1 1 0 011 1v4m0 0v8a2 2 0 01-2 2H6a2 2 0 01-2-2v-8m0 0V8a1 1 0 011-1h2m8 0V7a1 1 0 00-1-1h-4a1 1 0 00-1 1v1m8 0h2">
                                    </path>
                                </svg>
                        ...
                        <li>
                            <a href="{{ route('product.index') }}"
                                ...
                                <svg class="w-4 h-4 {{ session('lang') == 'ar' ? 'ml-2' : 'mr-2' }} text-gray-400 group-hover:text-emerald-500 transition-colors duration-200"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <li>
                            <a href="{{ route('order.index') }}"
                                ...
                                <svg class="w-4 h-4 {{ session('lang') == 'ar' ? 'ml-2' : 'mr-2' }} text-gray-400 group-hover:text-red-500 transition-colors duration-200"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                {{-- New orders badge --}}
                                <span
                                    class="inline-flex items-center justify-center w-4 h-4 {{ session('lang') == 'ar' ? 'mr-auto' : 'ml-auto' }} text-xs font-bold text-white bg-red-500 rounded-full animate-pulse">5</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="pt-6 mt-6 border-t border-gray-200/50">
                <h3
                    class="px-3 mb-3 text-xs font-semibold text-gray-500 uppercase tracking-wider {{ session('lang') == 'ar' ? 'text-right' : 'text-left' }}">
                    {{ session('lang') == 'en' ? 'Quick Stats' : 'إحصائيات سريعة' }}
                </h3>
                <div class="space-y-3">
                    {{-- Total Products --}}
                    <div
                        class="flex items-center justify-between p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200/30">
                        <div class="flex items-center">
                            ...
                            <div class="{{ session('lang') == 'ar' ? 'mr-3' : 'ml-3' }}">
                                <p class="text-xs text-gray-600">
                                    {{ session('lang') == 'en' ? 'Products' : 'المنتجات' }}</p>
                    ...
                    {{-- Total Orders --}}
                    <div
                        class="flex items-center justify-between p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200/30">
                        <div class="flex items-center">
                            ...
                            <div class="{{ session('lang') == 'ar' ? 'mr-3' : 'ml-3' }}">
                                <p class="text-xs text-gray-600">{{ session('lang') == 'en' ? 'Orders' : 'الطلبات' }}
                                </p>
                    ...
                    {{-- Revenue --}}
                    <div
                        class="flex items-center justify-between p-3 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-200/30">
                        <div class="flex items-center">
                            ...
                            <div class="{{ session('lang') == 'ar' ? 'mr-3' : 'ml-3' }}">
                                <p class="text-xs text-gray-600">
                                    {{ session('lang') == 'en' ? 'Revenue' : 'الإيرادات' }}</p>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        navLinks.forEach(link => {
            ...
            if (href && currentPath.includes(href)) {
                link.classList.add('bg-gradient-to-r', 'from-blue-100', 'to-purple-100',
