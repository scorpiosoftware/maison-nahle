<x-app-layout>
    ...
    <div class="py-6 group">
        <h1
            ...
            {{session('lang') == 'en' ? 'Users' : 'المستخدمين'}}
        </h1>
    </div>
    <div class="relative m-4 md:flex justify-between items-center">
        <form action="{{ route('user.index', 'search') }}" class="w-full max-w-md " method="GET">
            @csrf
            @method('GET')
            ...
            <div class="relative">
                ...
                <input type="search" id="search" name="search"
                    ...
                    placeholder="{{session('lang') == 'en' ? 'Search users...' : 'بحث عن المستخدمين...'}}" />
                <button type="submit"
    ...
    <livewire:admin-panel.users.user-table>
</x-app-layout>